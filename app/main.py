...
# Load MODEL_URLS from environment variable
try:
    MODEL_URLS_JSON = os.getenv("MODEL_URLS", "{}")
    MODEL_URLS = json.loads(MODEL_URLS_JSON)
    print("✅ Loaded MODEL_URLS from environment variables")
except Exception as e:
    print(f"❌ Error loading MODEL_URLS from environment: {e}")
    # Fallback URLs
    MODEL_URLS = {
    ...
    print("✅ Using fallback MODEL_URLS")

print(f"🚀 Environment: {os.getenv('ENVIRONMENT', 'development')}")
print(f"🔧 PORT: {PORT}")
print(f"📦 Model URLs loaded: {len(MODEL_URLS)}")
